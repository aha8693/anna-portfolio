...
const teamProjectItems: GraphicItem[] = [
...

  {
    ...
    description: "Analyzed AI ethics in healthcare diagnostic decision-making, proposing policy guidelines addressing transparency, privacy, accountability, justice, and safety to ensure responsible and unbiased use of AI in patient care. \n \n" + " • Skills: Literature Review·Ethical Frameworks",
